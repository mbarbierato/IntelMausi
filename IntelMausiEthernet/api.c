...
//  IntelMausi
//
//  Created by Massimiliano Barbierato on 25/10/22.
//  Copyright © 2022 Laura Müller. All rights reserved.
//
...
s32 e1000_init_mac_params(struct e1000_hw *hw)
{
    ...
    if (hw->mac.ops.init_params) {
        ...
        if (ret_val) {
            e_dbg("MAC Initialization Error\n");
            goto out;
        }
    } else {
        e_dbg("mac.init_mac_params was NULL\n");
...
s32 e1000_init_nvm_params(struct e1000_hw *hw)
{
    ...
    if (hw->nvm.ops.init_params) {
        ...
        if (ret_val) {
            e_dbg("NVM Initialization Error\n");
            goto out;
        }
    } else {
        e_dbg("nvm.init_nvm_params was NULL\n");
        ret_val = -E1000_ERR_CONFIG;
    }
...
s32 e1000_init_phy_params(struct e1000_hw *hw)
{
    ...
    if (hw->phy.ops.init_params) {
        ...
        if (ret_val) {
            e_dbg("PHY Initialization Error\n");
            goto out;
        }
    } else {
        e_dbg("phy.init_phy_params was NULL\n");
        ret_val =  -E1000_ERR_CONFIG;
    }
...
s32 e1000_init_mbx_params(struct e1000_hw *hw)
{
    ...
    if (hw->mbx.ops.init_params) {
        ...
        if (ret_val) {
            e_dbg("Mailbox Initialization Error\n");
            goto out;
        }
    } else {
        e_dbg("mbx.init_mbx_params was NULL\n");
        ret_val =  -E1000_ERR_CONFIG;
    }
...
s32 e1000_setup_init_funcs(struct e1000_hw *hw, bool init_device)
{
    ...
    if (ret_val) {
        e_dbg("ERROR: MAC type could not be set properly.\n");
        goto out;
    }

    if (!hw->hw_addr) {
        e_dbg("ERROR: Registers not mapped\n");
        ret_val = -E1000_ERR_CONFIG;
        goto out;
    }
